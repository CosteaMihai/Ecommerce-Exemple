<template>
    <form class="w-full max-w-2xl mx-auto mt-10">
        <div class="flex">
            ...
            <div class="w-1/2 py-2 border-b" :class="$v.user.phone.$error ? 'border-red-500' : 'border-blue-500'">
                <input
                    class="w-full px-2 py-1 mr-3 leading-tight text-gray-700 bg-transparent border-none appearance-none focus:outline-none"
                    type="tel"
        ...
        <div class="flex w-full">
            ...
            <div v-if="$v.user.phone.$error">
                ...
                <p v-else-if="!$v.user.phone.minLength" class="text-xs italic text-red-500">
        ...
        <div class="flex mt-10">
            <div
                ...
                :class="$v.user.password.$error ? 'border-red-500' : 'border-blue-500'"
            >
                <input
                    class="w-full px-2 py-1 mr-3 leading-tight text-gray-700 bg-transparent border-none appearance-none focus:outline-none"
                    type="password"
            ...
            <div
                ...
                :class="$v.user.confirmPassword.$error ? 'border-red-500' : 'border-blue-500'"
            >
                <input
                    class="w-full px-2 py-1 mr-3 leading-tight text-gray-700 bg-transparent border-none appearance-none focus:outline-none"
                    type="password"
        ...
        <div class="flex w-full">
            ...
            <div v-else-if="!$v.user.password.$error" class="w-1/2 h-1 mr-3"></div>
            <div v-if="$v.user.confirmPassword.$error">
                <p v-if="!$v.user.confirmPassword.required" class="text-xs italic text-red-500">
                    Repeat the password!
                </p>

                <p v-else-if="!$v.user.confirmPassword.sameAs" class="text-xs italic text-red-500">
        ...
        <div class="flex mt-10">
            <div
                class="w-1/2 py-2 mr-5 border-b"
                :class="$v.user.firstName.$error ? 'border-red-500' : 'border-blue-500'"
            >
                <input
                    class="w-full px-2 py-1 mr-3 leading-tight text-gray-700 bg-transparent border-none appearance-none focus:outline-none"
                    type="text"
            ...
            <div class="w-1/2 py-2 border-b" :class="$v.user.lastName.$error ? 'border-red-500' : 'border-blue-500'">
                <input
                    class="w-full px-2 py-1 mr-3 leading-tight text-gray-700 bg-transparent border-none appearance-none focus:outline-none"
                    type="text"
        ...
        <div class="flex w-full">
            <div v-if="$v.user.firstName.$error" class="w-1/2 mr-3">
                <p v-if="!$v.user.firstName.required" class="text-xs italic text-red-500">
                    Introduce your first name!
                </p>

                <p v-else-if="!$v.user.firstName.minLength" class="text-xs italic text-red-500">
                    First name must be at least 3 characters!
                </p>
            </div>
            <div v-else-if="!$v.user.firstName.$error" class="w-1/2 h-1 mr-3"></div>
            <div v-if="$v.user.lastName.$error">
                <p v-if="!$v.user.lastName.required" class="text-xs italic text-red-500">
                    Introduce your last name!
                </p>

                <p v-else-if="!$v.user.lastName.minLength" class="text-xs italic text-red-500">
        ...
        <div v-if="assignEmail" class="mt-5 text-sm italic text-red-500">Email already register!</div>
        <div v-if="assignPhone" class="mt-5 text-sm italic text-red-500">Phone number already used!</div>
    </form>
</template>
